...
**Note for React 19 users:** If you're using React 19, you may see a warning about peer dependency issues. When prompted with:
...
Select **"Use --force"** and continue with the installation. This will resolve the peer dependency conflicts and allow the components to install properly.
